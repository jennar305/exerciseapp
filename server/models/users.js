...
const list = [
    ...
    { 
        ...
        lastName: 'Rodriguez',
        username: '@jenna',
        pic: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Heart_coraz%C3%B3n.svg/1200px-Heart_coraz%C3%B3n.svg.png',
        bio: 'I love the gym!',
        password: 'hi',
        isAdmin: true,
        isPublic: true,
    ...
    { 
        ...
        lastName: 'Smith',
        handle: '@johnsmith',
        pic: 'https://i.insider.com/586c15f1ee14b6ce348b5f7e?width=889&format=jpeg',
        bio: 'Professional Gym Rat',
        password: 'BeepBop',
        isAdmin: true,
        isPublic: true,
        emails: [
    ...
    { 
        ...
        lastName: 'Doe',
        handle: '@janedoe',
        pic: 'https://discoverymood.com/wp-content/uploads/2020/04/Mental-Strong-Women-min.jpg',
        bio: 'I love to workout everyday.',
        password: 'byebye',
        isAdmin: true,
        isPublic: true,
        emails: [
